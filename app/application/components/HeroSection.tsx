...
<div className="absolute top-0 left-0 w-full h-[85vh] md:h-[95vh] z-0 overflow-hidden">
  ...
  <div className="absolute inset-0 bg-black/60" />
    ...
    <h1 className="text-white text-center z-10 mt-10 text-5xl font-semibold">
  <span>Best Platform for Application</span>
  <span className="block mt-[7px]">Hosting on PaaS</span>
</h1>
