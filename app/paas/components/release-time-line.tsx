...
export default function TimeLine_01({
  title = "Cloud Platform For Developers",
  description = "Deploy your application instantly on our fully redundant, high performance and scalable Cloud Platform-as-a-Service. Choose the required runtimes and install different software stacks just in a few clicks.",
            ...
            >
              ...
              <div className="top-8 flex h-min w-64 shrink-0 items-center gap-4 md:sticky">
                <div className="flex items-center gap-3">
                  ...
                  >
                    <entry.icon className="h-4 w-6" />
                  </div>
                  <div className="flex flex-col">
                    <span className="text-xl font-medium">{entry.title}</span>
